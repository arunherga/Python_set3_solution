...
6. How good are you really?
    ...
    But you're an ambitious person. You want to know if you're better than the average student in
    your class.
    You receive an array with your peers' test scores. Now calculate the average and compare your
    score!
...
def better_than_average(class_scores, my_score):
    sum = my_score
    for i in range(len(class_scores)):
        sum += class_scores[i]
    average = sum / (len(class_scores)+1)
